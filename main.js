...
ctx.drawImage(cloud, 100, 50, 75, 75);
ctx.drawImage(cloud, 200, 20, 75, 75);
ctx.drawImage(cloud, 150, 100, 75, 75);

// Text
ctx.font = "15px Arial";
ctx.fillStyle = "white";
ctx.fillText("Art by J.Bacque", 275, 385);
